    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#wip-form" onclick="addProduct()"><i class="fa fa-plus"></i> Add New WIP</button>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#import-product" onclick="importProduct()"><i class="fa fa-file-excel"></i> Import WIP (Excel)</button>
