    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                @if(Auth::user()->role == 0)
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-category" onclick="addCategory()"><i class="fa fa-plus"></i> Add New Category</button>
                @endif
            ...
            <div class="card-body">
                ...
                @if(count($categories) > 0)
                    ...
                    <tr>
                        ...
                        <td class="text-center"><button title="Lihat Produk Untuk Kategori Ini" type="button" class="btn btn-primary btn-xs" onclick="window.location.href='/products?category={{ $d->category_id }}'"><i class="fa fa-external-link"></i></button> @if(Auth::user()->role == 0)<button title="Edit Kategori" type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#add-category" onclick="editCategory({{ json_encode($data) }})"><i class="fa fa-edit"></i></button> <button title="Hapus Kategori" type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-category" onclick="deleteCategory({{ json_encode($data) }})"><i class="fa fa-trash"></i></button>@endif</td>
                    </tr>
                    @endforeach
                @else
                    <tr class="text-center">
