...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card-header">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-shelf" onclick="addShelf()"><i class="fa fa-plus"></i> Add New Shelf</button>
        </div>
        <div class="card-body">
            ...
            @if(count($shelf) > 0)
                ...
                <tr>
                    ...
                    <td class="text-center"><button title="Edit Shelf" type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#add-shelf" onclick="editShelf({{ json_encode($data) }})"><i class="fa fa-edit"></i></button> <button title="Hapus Shelf" type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-shelf" onclick="deleteShelf({{ json_encode($data) }})"><i class="fa fa-trash"></i></button></td>
                </tr>
                @endforeach
            @else
                <tr class="text-center">
